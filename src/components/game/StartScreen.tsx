...
import { BookOpen, Map, Star, Users, Settings } from "lucide-react";
...
const StartScreen = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center text-center">
      ...
      <p className="font-retro text-lg text-game-purple-dark mb-6">
        {getWelcomeMessage()}
      </p>
      
      {character ? (
        // Return player with character - show career dashboard
        ...
        // New player - show intro animation
        <div className="mb-8 relative">
          ...
          <p className="font-retro text-sm max-w-md mt-8 text-game-pixel-black">
      ...
      {/* Navigation Options */}
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mb-8 w-full max-w-md">
        <PixelButton 
          color="purple" 
        ...
        >
          ...
          <span>{character ? "Continue Quest" : "Start Quest"}</span>
        </PixelButton>
